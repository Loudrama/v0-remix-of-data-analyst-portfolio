...
import { Github, BarChart3, MessageSquare, Gamepad2, ExternalLink, Lightbulb, GraduationCap, Box } from "lucide-react"
...
const projects = [
  {
    ...
    githubUrl: "https://github.com/Loudrama/cub3d",
    highlights: [
  ...
  },
  {
    ...
    githubUrl: "https://github.com/Loudrama/transcendence",
    highlights: [
  ...
  },
  {
    ...
    icon: MessageSquare,
    technologies: ["C++", "Socket Programming", "Real-time Systems", "Server Architecture", "Data Processing"],
    githubUrl: "https://github.com/Loudrama/irc-server",
    highlights: ["Real-time messaging", "Multi-user support", "Network programming", "System optimization"],
  ...
  },
  {
    ...
    icon: Gamepad2,
    technologies: ["C Programming", "Game Logic", "Algorithm Design", "Problem Solving", "Performance Optimization"],
    githubUrl: "https://github.com/Loudrama/so-long",
    highlights: ["2D game mechanics", "Structured programming", "Logic implementation", "Algorithm optimization"],
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Key projects from 1337 School demonstrating analytical thinking, problem-solving skills, and technical
            growth in preparation for data analysis roles
          </p>
        </div>
                ...
                <CardHeader className="pb-6 relative z-10">
                  <div className="flex items-center justify-between mb-4">
                    <div className="p-3 bg-background/80 rounded-xl group-hover:scale-110 transition-transform duration-300">
                      <IconComponent className={`h-7 w-7 ${project.iconColor}`} />
                    </div>
        ...
        <div className="mt-20">
          <Card className="bg-gradient-to-r from-primary/5 via-background/80 to-emerald-500/5 border-border/50 hover:border-primary/30 transition-all duration-500 p-10 text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-4">Expanding Data Analysis Skills</h3>
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Actively pursuing IBM Data Analyst and Google Data Analytics certifications while gaining hands-on
                experience with Python, pandas, data visualization tools, and statistical analysis methods. Committed to
                continuous learning and applying analytical thinking to real-world data challenges.
              </p>
