...
export function Hero() {
    return (
        <section
            id="hero"
            className={`min-h-screen flex items-center justify-center px-6 relative overflow-hidden ${styles.heroNavFix}`}
        >
                ...
                <div className="space-y-10">
                    <div className="space-y-6">
                        ...
                        <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed animate-fade-in-delay-2">
                            1337 School student completing Common Core and
                            passionate about transforming data into insights.
                            Currently pursuing IBM Data Analyst and Google Data
                            Analytics certifications while seeking internship or
                            entry-level opportunities to grow and contribute to
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 animate-fade-in-delay-3">
                        ...
                        >
                            <a
                                href="/abdellah-amardoul-cv.pdf"
                                download="abdellah-amardoul-cv.pdf"
                            >
